...
1. Analizá la planilla sin modificarla.
2. Evaluá la cobertura total de cada producto como `stock actual + stock en tránsito`, en relación con el consumo promedio mensual.
3. Tratá el stock de seguridad como un límite mínimo que no debe consumirse normalmente.
4. Considerá conjuntamente los tiempos de fabricación y tránsito para determinar la urgencia de reposición.
5. Detectá los productos que requieren atención usando la fecha estimada de stock límite y la fecha sugerida del próximo pedido ya calculadas en la planilla.
6. No inventes ni recalcules esas fechas cuando la planilla ya las contenga.
7. Priorizá los casos más urgentes y presentá una recomendación breve, explícitamente sujeta a revisión humana.
